...
import com.example.anyrecipe.activities.CategoryMealsActivity
import com.example.anyrecipe.activities.MainActivity
import com.example.anyrecipe.activities.MealActivity
import com.example.anyrecipe.adapters.CategoriesAdapter
import com.example.anyrecipe.adapters.MostPopularAdapter
import com.example.anyrecipe.bottomsheet.MealBottomSheetFragment
import com.example.anyrecipe.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    companion object{
        ...
        const val CATEGORY_NAME = "com.example.anyrecipe.fragments.categoryName"
    }
    ...
    private fun observeCategoriesLiveData() {
        viewModel.observeCategoriesLiveData().observe(viewLifecycleOwner, Observer { categories ->
            val filteredCategories = categories.filterIndexed { index, _ -> index != 6 && index != 13 }
            categoriesAdapter.setCategoryList(filteredCategories)
        })
    }
